...
namespace Windows.UI.Tests.Enterprise.AppBarTests
{
	...
	public class AppBarIntegrationTests : BaseDxamlTestClass
	{
		...
		public async Task CanOpenAndCloseUsingAPI()
		{
			...
			await RunOnUIThread(() => page.Content = null);
		}
		...
		public async Task CanCloseNonStickyAppBarUsingEscapeKey()
		{
			...
			await RunOnUIThread(() =>
			{
				...
				stickyInlineAppBar = (AppBar)XamlReader.Load(@"
					<muxc:AppBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls"" xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml""
		...
		public async Task CanChangeAppBarHeightWithClosedDisplayMode()
		{
			...
			await RunOnUIThread(() =>
			{
				var root = (FrameworkElement)XamlReader.Load(@"
					<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""  xmlns:muxc=""using:Microsoft.UI.Xaml.Controls"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"">
						<muxc:AppBar x:Name=""appBar"" ClosedDisplayMode=""Minimal"" Width=""320""/>
					</Grid>
				");
		...
		public async Task ValidateAppBarWithParentedLTE()
		{
			...
			await RunOnUIThread(() =>
			{
				...
				appBar = (AppBar)XamlReader.Load(@"
					<muxc:AppBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls"" xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"" Width=""200"" Height=""80"">
                        <muxc:AppBarButton Label=""AppBarButton""/>
                    </muxc:AppBar>
				");
		...
		public async Task CanClosedDisplayModesAffectTabbingWhenClosed()
		{
			...
			rootPage = (Page)XamlReader.Load(@"
				<Page
					...
					<Page.TopAppBar>
						<muxc:AppBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls"" ClosedDisplayMode=""Minimal"">
							<StackPanel Orientation=""Horizontal"">
								<muxc:AppBarButton x:Name=""FirstAppBarButton"" Icon=""ReShare"" Label=""Share"" Tag=""AB1""/>
								<muxc:AppBarSeparator />
								<muxc:AppBarToggleButton Icon=""Favorite"" Label=""Favorite"" Tag=""AB2""/>
								<muxc:AppBarButton Icon=""Edit"" Label=""Edit"" Tag=""AB3""/>
							</StackPanel>
						</muxc:AppBar>
					</Page.TopAppBar>

					<Page.BottomAppBar>
						<muxc:AppBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls"" ClosedDisplayMode=""Compact"">
							<StackPanel Orientation=""Horizontal"">
								<muxc:AppBarButton Icon=""ReShare"" Label=""Share"" Tag=""AB4""/>
								<muxc:AppBarSeparator />
								<muxc:AppBarToggleButton Icon=""Favorite"" Label=""Favorite"" Tag=""AB5""/>
								<muxc:AppBarButton Icon=""Edit"" Label=""Edit"" Tag=""AB6""/>
							</StackPanel>
						</muxc:AppBar>
					</Page.BottomAppBar>
			...
			await RunOnUIThread(() =>
			{
				...
				WindowHelper.WindowContent = rootPage;
			});
			...
			await RunOnUIThread(() =>
			{
				var rootPanel = (StackPanel)XamlReader.Load(@"
					<StackPanel xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
								...
								Width=""400""
								Height=""600"">
                        <muxc:AppBar x:Name=""appBarCompactClosed"" IsOpen=""False"" ClosedDisplayMode=""Compact""/>
                        <muxc:AppBar x:Name=""appBarCompactOpen"" IsOpen=""True"" ClosedDisplayMode=""Compact""/>
                        <muxc:AppBar x:Name=""appBarMinimalClosed"" IsOpen=""False"" ClosedDisplayMode=""Minimal""/>
                        <muxc:AppBar x:Name=""appBarMinimalOpen"" IsOpen=""True"" ClosedDisplayMode=""Minimal""/>
                        <muxc:AppBar x:Name=""appBarHiddenClosed"" IsOpen=""False"" ClosedDisplayMode=""Hidden""/>
                        <muxc:AppBar x:Name=""appBarHiddenOpen"" IsOpen=""True"" ClosedDisplayMode=""Hidden""/>
                    </StackPanel>
				");
		...
		public async Task ValidateLightDismissOverlayMode()
		{
			...
			await RunOnUIThread(() =>
			{
				...
				WindowHelper.WindowContent = appBar;
			});
			await WindowHelper.WaitForIdle();
			...
			await RunOnUIThread(() =>
			{
				root = (Grid)XamlReader.Load(@"
					<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml""
                            ...
                            <muxc:AppBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls"" IsOpen=""True"" LightDismissOverlayMode=""On"">
                                <muxc:AppBarButton x:Name=""button""/>
                            </muxc:AppBar>
                        </Grid>
				");
			...
			await RunOnUIThread(() =>
			{
				var root = (FrameworkElement)XamlReader.Load(@"
					<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:muxc=""using:Microsoft.UI.Xaml.Controls"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml""
                        ...
                        <StackPanel>
                            <muxc:AppBar  x:Name=""appBar"">
                                <muxc:AppBarButton x:Name=""appBarButton"" Icon=""Add"" Label=""Add""/>
                            </muxc:AppBar>
                        </StackPanel>
                    </Grid>
				");
		...
		private async Task<Page> SetupTopBottomInlineAppBarsPage()
		{
			...
			await RunOnUIThread(() =>
			{
				...
				var panel = (StackPanel)XamlReader.Load(@"
					<StackPanel xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:muxc=""using:Microsoft.UI.Xaml.Controls"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"">
						<muxc:AppBar x:Name=""inlineAppBar"" VerticalAlignment=""Center"">
