...
using AppBarAutomationPeer = Microsoft.UI.Xaml.Automation.Peers.AppBarAutomationPeer;
using AppBarTemplateSettings = Microsoft.UI.Xaml.Controls.Primitives.AppBarTemplateSettings;
...
#pragma warning restore CS0169
		...
		~AppBar()
		{
			if (Windows.UI.Xaml.Window.Current is { } window)
			{
