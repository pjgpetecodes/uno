...
using AppBarAutomationPeer = Windows.UI.Xaml.Automation.Peers.AppBarAutomationPeer;
using AppBarTemplateSettings = Windows.UI.Xaml.Controls.Primitives.AppBarTemplateSettings;
