...
using CommandBarOverflowPresenter = Microsoft.UI.Xaml.Controls.CommandBarOverflowPresenter;
using AppBar = Microsoft.UI.Xaml.Controls.AppBar;
...
using AppBarSeparator = Microsoft.UI.Xaml.Controls.AppBarSeparator;
using DynamicOverflowItemsChangingEventArgs = Microsoft.UI.Xaml.Controls.DynamicOverflowItemsChangingEventArgs;
using CommandBarDefaultLabelPosition = Microsoft.UI.Xaml.Controls.CommandBarDefaultLabelPosition;
using CommandBarLabelPosition = Microsoft.UI.Xaml.Controls.CommandBarLabelPosition;
using CommandBarOverflowButtonVisibility = Microsoft.UI.Xaml.Controls.CommandBarOverflowButtonVisibility;
using CommandBarDynamicOverflowAction = Microsoft.UI.Xaml.Controls.CommandBarDynamicOverflowAction;
using AppBarClosedDisplayMode = Microsoft.UI.Xaml.Controls.AppBarClosedDisplayMode;
using ICommandBarElement = Microsoft.UI.Xaml.Controls.ICommandBarElement;
using Uno.UI;

namespace Windows.UI.Tests.Enterprise.CommandBarTests
{
	[TestClass]
	[RequiresFullWindow]
	public class CommandBarIntegrationTests : BaseDxamlTestClass
	{
                                ...
                                <Popup x:Name=""OverflowPopup"">
                                    ...
                                    <Grid x:Name=""OverflowContentRoot"">
                                        ...
                                        <CommandBarOverflowPresenter x:Name=""SecondaryItemsContro""
                                            ...
                                            </muxc:CommandBarOverflowPresenter.RenderTransform>
                                            <CommandBarOverflowPresenter.ItemContainerStyle>
                                                <Style TargetType=""FrameworkElement"">
                                                    <Setter Property=""HorizontalAlignment"" Value=""Stretch""/>
                                                    <Setter Property=""Width"" Value=""NaN""/>
                                                </Style>
                                            </muxc:CommandBarOverflowPresenter.ItemContainerStyle>
                                        </muxc:CommandBarOverflowPresenter>
                                    </Grid>
                                </Popup>
		...
		public async Task CanAddToAndRemoveFromCommandCollections()
		{
			...
			await RunOnUIThread(() =>
			{
				CommandBar cmdBar = (CommandBar)XamlReader.Load(@"
					<muxc:CommandBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls"" >
                        <muxc:AppBarToggleButton Label=""btn1""/>
                        <muxc:AppBarButton Label=""btn2""/>
                        <muxc:CommandBar.SecondaryCommands>
                            <muxc:AppBarToggleButton  Label=""btn3""/>
                            <muxc:AppBarButton  Label=""btn4""/>
                        </muxc:CommandBar.SecondaryCommands>
                    </muxc:CommandBar>
				");
		...
		public async Task CanResizeCommandBarAfterOpeningAndClosing()
		{
			...
			await RunOnUIThread(() =>
			{
				cmdBar = (CommandBar)XamlReader.Load(@"
					<muxc:CommandBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  Margin=""0,0,100,0"">
                        <muxc:AppBarButton  Label=""btn1""/>
                        <muxc:AppBarButton  Label=""btn2""/>
                        <muxc:AppBarButton  Label=""btn3""/>
                        <muxc:AppBarButton  Label=""btn4""/>
                        <muxc:AppBarButton  Label=""btn5""/>
                        <muxc:CommandBar.SecondaryCommands>
                            <muxc:AppBarButton  Label=""btn1""/>
                            <muxc:AppBarButton  Label=""btn2""/>
                            <muxc:AppBarButton  Label=""btn3""/>
		...
		public async Task CanUseLargeAppBarButton()
		{
			...
			await RunOnUIThread(() =>
			{
				cmdBar = (CommandBar)XamlReader.Load(@"
					<muxc:CommandBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  >
                      <muxc:CommandBar.SecondaryCommands>
                        <muxc:AppBarButton  Label=""AppBarButton"" Height=""1000"">
                          <muxc:AppBarButton.Flyout>
                            <MenuFlyout>
		...
		private async Task DoesCycleFocusWhenOpenWorker(Location location, int numTabs, string expectedFocusSequence)
		{
			...
			await RunOnUIThread(() =>
			{
				...
				cmdBar = (CommandBar)XamlReader.Load(@"
					<muxc:CommandBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  >
                        <muxc:AppBarButton  Tag=""P1""/>
                        <muxc:AppBarButton  Tag=""P2""/>
                        <muxc:AppBarButton  Tag=""P3""/>
                        <muxc:CommandBar.SecondaryCommands>
                            <muxc:AppBarButton  Tag=""S1""/>
                            <muxc:AppBarButton  Tag=""S2""/>
                            <muxc:AppBarButton  Tag=""S3""/>
                        </muxc:CommandBar.SecondaryCommands>
                    </muxc:CommandBar>
				");
		...
		public async Task DoesFocusExpandButtonWithOverflowEscKey()
		{
			...
			Page rootPage = (Page)XamlReader.Load(@"<Page    
				...
				<Grid Background=""{ThemeResource ApplicationPageBackgroundThemeBrush}"">
					<StackPanel>
						<muxc:CommandBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  x:Name=""topCommandBar"">
							<muxc:CommandBar.SecondaryCommands>
								<muxc:AppBarButton  Label=""AppBarButton"" VerticalAlignment=""Top"" x:Name=""topOverflowAppBarBtn0""/>
								<muxc:AppBarToggleButton  Label=""AppBarToggleButton"" VerticalAlignment=""Top"" x:Name=""topOverflowAppBarBtn1""/>
								<muxc:AppBarSeparator />
							</muxc:CommandBar.SecondaryCommands>
							<muxc:AppBarButton  Label=""AppBarButton"" Icon=""FourBars"" x:Name=""topAppBarBtn0""/>
							<muxc:AppBarToggleButton  Label=""AppBarToggleButton"" Icon=""HangUp"" x:Name=""topAppBarBtn1""/>
							<muxc:AppBarSeparator />
						</muxc:CommandBar>
				...
				<Page.BottomAppBar>
					<muxc:CommandBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  x:Name=""bottomCommandBar"">
						<muxc:AppBarToggleButton  Icon=""Shuffle"" Label=""Shuffle"" x:Name=""bottomAppBarBtn0""/>
						<muxc:AppBarToggleButton  Icon=""RepeatAl"" Label=""Repeat"" x:Name=""bottomAppBarBtn1""/>
						<muxc:AppBarSeparator />
						<muxc:AppBarButton  Icon=""Back"" Label=""Back"" x:Name=""bottomAppBarBtn2""/>
						<muxc:AppBarButton  Icon=""Stop"" Label=""Stop"" x:Name=""bottomAppBarBtn3""/>
						<muxc:AppBarButton  Icon=""Play"" Label=""Play"" x:Name=""bottomAppBarBtn4""/>

						<muxc:CommandBar.SecondaryCommands>
							<muxc:AppBarButton  Icon=""Like"" Label=""Like"" x:Name=""bottomOverflowAppBarBtn0""/>
							<muxc:AppBarButton  Icon=""Dislike"" Label=""Dislike"" x:Name=""bottomOverflowAppBarBtn1""/>
						</muxc:CommandBar.SecondaryCommands>
					</muxc:CommandBar>
				</Page.BottomAppBar>
			</Page>");
		...
		public async Task ValidateMenuSizingForDifferentInputModes()
		{
...
#else
			double expectedMenuItemHeight_NonTouch = 34;
#endif
			...
			await RunOnUIThread(() =>
			{
				root = (Grid)XamlReader.Load(@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                        ...
                        <muxc:CommandBar x:Name=""cmdBar"" VerticalAlignment=""Bottom"" HorizontalAlignment=""Center"" >
                            <muxc:CommandBar.SecondaryCommands>
                                <muxc:AppBarButton x:Name=""appBarButton"" Label=""Item 1"" />
                                <muxc:AppBarToggleButton x:Name=""appBarToggleButton"" Label=""Item 2"" />
                            </muxc:CommandBar.SecondaryCommands>
                        </muxc:CommandBar>
                    </Grid>");
		...
		public async Task ValidateVisualStateForFullWidthMenu()
		{
			...
			await RunOnUIThread(() =>
			{
				var root = (Grid)XamlReader.Load(@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                          xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"" >
                        <muxc:CommandBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  x:Name=""cmdBar"" VerticalAlignment=""Bottom"" >
                            <muxc:CommandBar.SecondaryCommands>
                                <muxc:AppBarButton  Label=""Item 1"" />
                                <muxc:AppBarToggleButton  Label=""Item 2"" />
                            </muxc:CommandBar.SecondaryCommands>
                        </muxc:CommandBar>
                    </Grid>");
		...
		public async Task MoveItemsBetweenPrimaryAndSecondaryCommands()
		{
			...
			await RunOnUIThread(() =>
			{
				root = (Grid)XamlReader.Load(@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                          xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml""  xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  >
                        <muxc:CommandBar x:Name=""cmdBar"" VerticalAlignment=""Bottom"" HorizontalAlignment=""Center"" >
                            <muxc:CommandBar.PrimaryCommands>
                                <muxc:AppBarButton  x:Name=""appBarButton1"" Label=""Item 1"" />
                                <muxc:AppBarToggleButton  x:Name=""appBarToggleButton1"" Label=""Item 2"" />
                            </muxc:CommandBar.PrimaryCommands>
                            <muxc:CommandBar.SecondaryCommands>
                                <muxc:AppBarButton  x:Name=""appBarButton2"" Label=""Item 4"" />
                                <muxc:AppBarToggleButton  x:Name=""appBarToggleButton2"" Label=""Item 5"" />
                            </muxc:CommandBar.SecondaryCommands>
                        </muxc:CommandBar>
                    </Grid>");
		...
		public async Task ValidateFootprint()
		{
			...
			await RunOnUIThread(() =>
			{
				var rootPanel = (StackPanel)XamlReader.Load(@"<StackPanel  xmlns:muxc=""using:Microsoft.UI.Xaml.Controls"" xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"">
                        <muxc:CommandBar  x:Name=""cmdBarCompactClosed"" IsOpen=""False"" ClosedDisplayMode=""Compact""/>
                        <muxc:CommandBar  x:Name=""cmdBarCompactOpen"" IsOpen=""True"" ClosedDisplayMode=""Compact""/>
                        <muxc:CommandBar  x:Name=""cmdBarMinimalClosed"" IsOpen=""False"" ClosedDisplayMode=""Minimal""/>
                        <muxc:CommandBar  x:Name=""cmdBarMinimalOpen"" IsOpen=""True"" ClosedDisplayMode=""Minimal""/>
                        <muxc:CommandBar  x:Name=""cmdBarHiddenClosed"" IsOpen=""False"" ClosedDisplayMode=""Hidden""/>
                        <muxc:CommandBar  x:Name=""cmdBarHiddenOpen"" IsOpen=""True"" ClosedDisplayMode=""Hidden""/>
                    </StackPanel>");
		...
		public async Task ValidateDynamicOverflowWithCustomAppBarButton()
		{
			...
			await RunOnUIThread(() =>
			{
				...
				cmdBar = (CommandBar)XamlReader.Load(@"<muxc:CommandBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                                xmlns:local=""using:Windows.UI.Tests.Enterprise.CustomTypes"">
                        <muxc:CommandBar.Resources>
		...
		public async Task CanArrowIntoTheContentArea()
		{
			...
			{
				cmdBar = (CommandBar)XamlReader.Load(@"<muxc:CommandBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"">
                        <muxc:AppBarButton  Label=""button"" Icon=""Accept""/>
		...
		public async Task DoesOpenOverflowWithArrowInputOnMoreButton()
		{
			...
			await RunOnUIThread(() =>
			{
				cmdBar = (CommandBar)XamlReader.Load(@"<muxc:CommandBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"">
                        <muxc:CommandBar.SecondaryCommands>
                            <muxc:AppBarButton  Label=""menu item 1"" />
                            <muxc:AppBarButton  Label=""menu item 2"" />
                            <muxc:AppBarButton  Label=""menu item 3"" />
                        </muxc:CommandBar.SecondaryCommands>
                    </muxc:CommandBar>");
		...
		public async Task ValidateForegroundForXamlUICommand()
		{
			...
			await RunOnUIThread(() =>
			{
				root = (Grid)XamlReader.Load(@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                            ...
                            <muxc:CommandBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  DefaultLabelPosition=""Right"" Foreground=""Blue"">
                                <muxc:AppBarButton  x:Name=""Button1"" IsEnabled=""False"" Label=""Accept"" >
                                    <IconSourceElement>
                                            <SymbolIconSource Symbol=""Favorite"" Foreground=""Red"" />
                                    </IconSourceElement>
                                </AppBarButton>
                                <muxc:AppBarButton  x:Name=""ButtonWithCommand1"" IsEnabled=""False"" Command=""{StaticResource AcceptCommand}"" />
                                <muxc:AppBarToggleButton  x:Name=""ButtonWithCommand2"" IsEnabled=""False"" Command=""{StaticResource FavoriteCommand}"" />
                            </muxc:CommandBar>
                        </Grid>");
		...
		public async Task ValidateButtonsMoveToAndFromOverflowWithoutSizeChange()
		{
			...
			await RunOnUIThread(() =>
			{
				rootGrid = (Grid)XamlReader.Load(@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation"" xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"">
                        <Grid>
                            <Grid.ColumnDefinitions>
                            ...
                            <Grid>
                                <muxc:CommandBar HorizontalAlignment=""Right"" x:Name=""CommandBar"">
                                    <muxc:AppBarButton Icon=""Add"" Label=""Add""/>
                                </muxc:CommandBar>
                            </Grid>
		...
		public async Task VerifyVisibilityChangeUpdatesCommandBarVisualState()
		{
			...
			await RunOnUIThread(() =>
			{
				var root = (Grid)XamlReader.Load(@"<Grid xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                          xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"" >
                        <muxc:CommandBar  x:Name=""cmdBar"" VerticalAlignment=""Top"" >
                            <muxc:AppBarButton  Label=""Item 1"" Name=""button"" Visibility=""Collapsed""/>
                            <muxc:CommandBar.SecondaryCommands>
                                <muxc:AppBarButton Label=""Item 2""/>
                            </muxc:CommandBar.SecondaryCommands>
                        </muxc:CommandBar>
                    </Grid>");
		...
		public async Task ValidateResetingTheStateOfAppBarButton()
		{
			...
			await RunOnUIThread(() =>
			{
				root = (Grid)XamlReader.Load(@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
                              xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml"" xmlns:muxc=""using:Microsoft.UI.Xaml.Controls"">
                        <muxc:CommandBar  x:Name=""cmdBar"">
                            <muxc:AppBarButton  x:Name=""Button"" Icon=""Add""/>
                            <muxc:AppBarToggleButton  x:Name=""ToggleButton"" Icon=""AddFriend"" />
                            <muxc:AppBarButton  IsEnabled=""False"" Icon=""Cancel"" Label=""PlaceHolder"" />
                            <muxc:AppBarButton  x:Name=""ApproveButton"" Icon=""Accept"" />
                        </muxc:CommandBar>
                    </Grid>");
						...
						<Button x:Name=""FlyoutButton"" Content=""Click for flyout"">
							<Button.Flyout>
								<Flyout x:Name=""CommandBarFlyout"">
									<muxc:CommandBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  x:Name=""CommandBar"" IsOpen=""True"" Width=""300"">
										<muxc:CommandBar.SecondaryCommands>
											<muxc:AppBarButton  x:Name=""MenuFlyoutAppBarButton1"" Label=""Open menu flyout"">
												<muxc:AppBarButton.Flyout>
											...
											<muxc:AppBarButton  x:Name=""MenuFlyoutAppBarButton2"" Label=""Open other menu flyout"">
												<muxc:AppBarButton.Flyout>
											...
											<muxc:AppBarButton  x:Name=""MenuFlyoutAppBarButton3"" Label=""Open third menu flyout"">
												<muxc:AppBarButton.Flyout>
											...
											<muxc:AppBarButton  x:Name=""AppBarButtonWithoutFlyout"" Label=""No menu flyout"" />
											<muxc:AppBarToggleButton  x:Name=""AppBarToggleButton"" Label=""No menu flyout"" />
										</muxc:CommandBar.SecondaryCommands>
									</muxc:CommandBar>
								</Flyout>
							</Button.Flyout>
			...
			await RunOnUIThread(() =>
			{
				...
				var root = (Grid)(XamlReader.Load(
					@"<Grid xmlns=""http://schemas.microsoft.com/winfx/2006/xaml/presentation""
							  xmlns:x=""http://schemas.microsoft.com/winfx/2006/xaml""
							  Background=""Transparent"">
							<muxc:CommandBar xmlns:muxc=""using:Microsoft.UI.Xaml.Controls""  x:Name=""CommandBar"" Width=""300"">
								<muxc:CommandBar.SecondaryCommands>
									<muxc:AppBarButton  x:Name=""FlyoutAppBarButton"" Label=""Open flyout"">
										<muxc:AppBarButton.Flyout>
									...
									<muxc:AppBarButton  x:Name=""OtherAppBarButton"" Label=""Other AppBarButton"" />
								</muxc:CommandBar.SecondaryCommands>
							</muxc:CommandBar>
						</Grid>"));
